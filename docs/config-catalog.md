...
Source: [`packages/client/ui-local-model-desktop/src/index.ts:8`](../packages/client/ui-local-model-desktop/src/index.ts)
...
Source: [`packages/llm/llm-local/src/index.ts:19`](../packages/llm/llm-local/src/index.ts)
