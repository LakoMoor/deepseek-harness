...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-local-model-desktop LocalModelSettingsCard id \'desktop-local-model\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar.settings\' (client-ui-settings-general), so it exists while that entry is mounted',
    occupants: [
      'client-ui-local-model-desktop LocalModelOnboarding id \'desktop-local-model\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-local-model-desktop DesktopTitleBar id \'desktop-title-bar\'',
    ],
    replaceRisk: 'none',
